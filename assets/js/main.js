...
//year
var ctx = document.getElementById('topic').getContext('2d'); // get the canvas element
var myChart = new Chart(ctx, { // create a new chart
    type: 'radar',
    data: {
        labels: label, // set the labels
...
//Country
var ctx = document.getElementById('country').getContext('2d'); // get the canvas element
var myChart = new Chart(ctx, { // create a new chart
    type: 'bubble',
    data: {
        labels: label, // set the labels
...
//start_year
var ctx = document.getElementById('start_year').getContext('2d'); // get the canvas element
var myChart = new Chart(ctx, { // create a new chart
    type: 'scatter',
    data: {
        labels: label, // set the labels
...
//region
var ctx = document.getElementById('region').getContext('2d'); // get the canvas element
var myChart = new Chart(ctx, { // create a new chart
    type: 'doughnut',
    data: {
        labels: label, // set the labels
...
//city
var ctx = document.getElementById('city').getContext('2d'); // get the canvas element
var myChart = new Chart(ctx, { // create a new chart
    type: 'pie',
    data: {
        labels: label, // set the labels
